...
export const VideoDetectionFrame = () => {
  const textAreaRef = useRef<TextAreaRef>(null);
  const {
    videoDetectionText,
    blockToUpdate,
    videoDetectionFrameDisplay,
    editor,
    loadingDisplay,
  } = useNewDocState();
  ...
  useEffect(() => {
    ...
    setDisplay(videoDetectionFrameDisplay);
  }, [blockToUpdate, videoDetectionFrameDisplay]);
  return (
    <div
      className={`${
        display ? "" : "hidden"

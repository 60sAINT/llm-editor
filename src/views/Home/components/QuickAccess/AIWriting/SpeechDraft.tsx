    ...
    <>
      <div className="h-20 flex items-center w-full">
        ...
        <div className="flex flex-col">
          <div className="text-topbar-text h-6 leading-6 font-bold">演讲稿</div>
          <div className="leading-5 text-xs text-stone-500">
            根据给定主题和字数，生成优美流畅、情真意切的学生发言稿
          </div>
        </div>
      </div>
      ...
      <Form form={form} name={OPERATE.SPEECH}>
        <div className="flex justify-between h-12 items-center">
          <div className="text-topbar-text">演讲主题</div>
          <Form.Item
            name="title"
            rules={[{ required: true, message: "请填写演讲主题！" }]}
            className="w-ai-writing-form-item mb-0"
          >
            <Input placeholder="请输入演讲主题" className="h-10" />
          </Form.Item>
        </div>
        ...
        <div className="flex justify-between h-12 items-center mt-3">
          <div className="text-topbar-text">演讲场景</div>
          <Form.Item
            name="title"
            rules={[{ required: true, message: "请填写演讲场景！" }]}
            className="w-ai-writing-form-item mb-0"
          >
            <Input placeholder="请输入演讲场景" className="h-10" />
          </Form.Item>
        </div>
